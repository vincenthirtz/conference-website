// pages/admin/scrims/plannings/index.tsx
// Admin: liste des grilles de planification de scrim (« When2Meet » partagé).
...
import type { StaffProps, ScrimPlanning } from '@/types/admin';
...
function AdminScrimPlanningsPage(_props: StaffProps) {
...
export default AdminScrimPlanningsPage;
