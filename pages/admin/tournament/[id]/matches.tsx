...
function AdminTournamentMatchesPage({ staff }: StaffProps) {
  ...
  // auto-scheduler
  const [autoSchedRunning, setAutoSchedRunning] =
    useState(false);
  const [autoSchedMsg, setAutoSchedMsg] =
  ...
  async function handleAutoSchedule() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(
          json.error ||
            "Erreur lors de l'auto-scheduler"
        );
      }
        ...
        <div className="bg-neutral-800 border border-neutral-700 rounded-xl overflow-hidden">
          <div className="px-4 py-3 border-b border-neutral-700 flex justify-between items-center">
            ...
            <span className="text-xs text-neutral-400">
              Trié du plus récent au plus ancien par horaires /
              création (géré côté API).
            </span>
          </div>
