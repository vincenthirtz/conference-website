...
function FeatureIcon({ name }: { name: IconName }) {
  const common = {
    className: 'w-6 h-6 text-[var(--color-violet-light)]',
    fill: 'none' as const,
    stroke: 'currentColor',
    strokeWidth: 1.8,
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <main className="mx-auto max-w-5xl space-y-14 px-4 pb-20 sm:px-6">
        ...
        <section className="rounded-3xl border border-white/10 bg-gradient-to-r from-[#140a24] via-[#1c0f33] to-[#2a0d3d] p-6 sm:p-10 shadow-2xl">
          ...
          <ul className="mt-5 grid gap-3 sm:grid-cols-2">
            {t.forWhoItems.map((item) => (
              ...
              >
                <span
                  className="brand-dot mt-[6px] h-2 w-2 shrink-0 rounded-full"
                  aria-hidden
                />
                <span>{item}</span>
              </li>
        ...
        {/* Features */}
        <section id="fonctionnalites" className="section-brand-bg scroll-mt-24">
          <div className="mb-6">
            ...
            {t.features.map((feature) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--color-violet)]/40 to-[var(--color-green)]/40 ring-1 ring-white/10">
