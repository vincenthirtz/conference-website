...
async function handleGet(matchId: string, req: NextApiRequest, res: NextApiResponse) {
...
async function handlePut(matchId: string, req: NextApiRequest, res: NextApiResponse, ctx) {
  const { team1Score, team2Score, winnerTeamId, status, propagate = true } = req.body;
...
async function handleDelete(matchId: string, req: NextApiRequest, res: NextApiResponse, ctx) {
