// GET /api/bot/players/by-discord/[discordUserId]/team
//
...
export default async function handler(
  ...
  if (
    applyRateLimit(req, res, { max: 60, windowMs: 60_000 }, 'bot-player-team')
  )
    return;
  if (!process.env.BOT_API_KEY) {
    logger.error('[bot/player/team] BOT_API_KEY is unset');
