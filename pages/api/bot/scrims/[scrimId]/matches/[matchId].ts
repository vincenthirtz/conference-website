// PATCH /api/bot/scrims/[scrimId]/matches/[matchId]
//
...
export default async function handler(
  ...
  if (
    applyRateLimit(req, res, { max: 60, windowMs: 60_000 }, 'bot-scrim-match-patch')
  )
    return;

  if (!process.env.BOT_API_KEY) {
    logger.error('[bot/scrim-match] BOT_API_KEY is unset');
