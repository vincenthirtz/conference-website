...
INSERT INTO twitch_channels (channel, label, badge, description, background_url, sort_order) VALUES
  ...
  ('misskiwiii', 'MissKiwiii', 'Player', 'Joueuse Overwatch avec bonne humeur, scrims avec la team Sparkles (tenante du titre 2025).', 'https://static-cdn.jtvnw.net/jtv_user_pictures/6324195a-0d2a-4966-93e5-3970ef1af174-profile_image-150x150.png', 7),
  ...
  ('eiko_live', 'Eiko_Live', 'Player', 'Streams Overwatch avec une ambiance chill et des conseils gameplay. Joueuse de l''équipe Avoidgers', 'https://static-cdn.jtvnw.net/jtv_user_pictures/8e26e1e3-e8d3-4ed1-8a3c-42199cda7741-profile_image-150x150.png', 9),
  ...
  ('ooh_jaz', 'Ooh_Jaz', 'Player', 'Casts et parties classées Overwatch, avec focus dps et ambiance chill. Joueuse des Onna Bugeisha', 'https://static-cdn.jtvnw.net/jtv_user_pictures/5dda95ec-d9d0-4e30-bb3f-6fd0211cdeb0-profile_image-150x150.png', 12)
