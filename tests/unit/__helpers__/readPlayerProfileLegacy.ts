// tests/unit/__helpers__/readPlayerProfileLegacy.ts
//
// COPIE FIGÉE de utils/rating/readPlayerProfile.ts telle qu'elle était AVANT
// l'optimisation (vague 4c : parallélisation + lecture groupée des badges).
// Elle ne sert qu'aux tests de PARITÉ : la nouvelle implémentation doit rendre
// exactement ce que rendait celle-ci. NE PAS la faire évoluer avec le code —
// sa seule valeur est de ne pas bouger.
//
// --- En-tête d'origine ---
//
//
