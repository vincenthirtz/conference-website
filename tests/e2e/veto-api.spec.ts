...
test.describe('Veto API protection (sans auth)', () => {
  test('GET /api/admin/matches/[matchId]/veto returns 401/403 without auth', async ({
    request,
  }) => {
  ...
  test('POST /api/admin/matches/[matchId]/veto returns 401/403 without auth', async ({
    request,
  }) => {
  ...
  test('DELETE /api/admin/matches/[matchId]/veto returns 401/403 without auth', async ({
    request,
  }) => {
  ...
  test('GET /api/admin/matches/[matchId]/veto returns 401/403 with invalid token', async ({
    request,
  }) => {
    const res = await request.get(`/api/admin/matches/${fakeMatchId}/veto`, {
...
test.describe('Veto page protection', () => {
  test('GET /admin/tournament/fake-id/veto redirige vers login', async ({
    page,
  }) => {
    await page.goto(
      '/admin/tournament/00000000-0000-0000-0000-000000000000/veto'
    );
...
test.describe('Map stats API (public)', () => {
  test('GET /api/maps/stats without tournamentId returns 400', async ({
    request,
  }) => {
  ...
  test('GET /api/maps/stats with fake tournamentId returns empty', async ({
    request,
  }) => {
