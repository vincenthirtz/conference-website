            ...
            <div className="flex flex-col justify-center items-center w-full">
              ...
              <div className="mt-10 relative flex items-center justify-center">
                <Link href="https://discord.gg/gERSsjC3Vd" target="_blank">
                  <button
                    type="button"
                    className="group flex items-center gap-3 px-8 py-4 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold text-lg shadow-lg shadow-[#5865F2]/25 hover:shadow-[#5865F2]/40 transition-all duration-300 hover:scale-105"
                  >
                    <svg
