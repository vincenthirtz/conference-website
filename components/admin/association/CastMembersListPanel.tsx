// components/admin/association/CastMembersListPanel.tsx
// Admin: liste des casteuses/casters du tenant + modale de création et
// réordonnancement drag-and-drop. Rendered as the "Casteuses" tab of the
// /admin/association hub.
//
// Endpoints:
//   GET    /api/admin/cast-members?status=&includeInactive=&limit=&offset=&q=
//   PATCH  /api/admin/cast-members/[id]   → { isActive } | { sortOrder }
//   DELETE /api/admin/cast-members/[id]
//
// Deep-link `?new=1` (ex-route /cast-members/new) ouvre la modale de création.
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-shrink-0 text-center">
                    <span className="text-xs text-neutral-500">{tx.order}</span>
