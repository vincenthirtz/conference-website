...
//
// Extrait de pages/player/notifications.tsx (S3 de docs/PLAN-espace-unifie.md)
// pour être rendu tel quel dans la vue d'inspection admin.
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 pt-24 pb-16">
        ...
        <div className="space-y-8">
          {/* (a) Invitations reçues — masquée s'il n'y en a aucune.
              En inspection : /api/player/invitations est lisible mais accepter
              une invitation à la place de quelqu'un ne l'est pas, et la section
              est entièrement actionnable — on la masque. */}
          {!readOnly && (
          ...
          {/* (c) Préférences — personnelles et non inspectables (device +
              consentement). Masquées dès qu'on regarde quelqu'un d'autre. */}
          {!isInspecting && (
            <section>
              <h2 className="text-lg font-semibold mb-4 text-white">
                {t.prefsHeading}
