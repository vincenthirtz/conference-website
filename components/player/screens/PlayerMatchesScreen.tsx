...
//
// Corps de « Mes matchs » — extrait de pages/player/matches.tsx (S2 de
// docs/PLAN-espace-unifie.md). Liste les matchs de l'equipe du joueur,
// scindes en "A venir" et "Resultats". Donnees via GET /api/player/matches,
// redirigé vers l'utilisateur inspecté quand la page hôte en fournit un.
//
...
export default function PlayerMatchesScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-[#050509] to-black text-white">
      <main className="max-w-4xl mx-auto px-4 py-10 pt-header pb-16">
        <div className="mb-8">
