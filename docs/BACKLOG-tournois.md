...
| A6 | Unification des 3 idiomes temporels (datetime-local négociation / grille When2Meet / agenda drag&drop). Décomposé : **A6a** clarté de fuseau + écho lisible dans le picker de négociation ✅ LIVRÉ · **A6b** picker de négociation basé calendrier (⏳, chantier UX) · **A6c** helpers date/fuseau partagés entre les 3 surfaces (⏳). | L | ◐ EN COURS |
