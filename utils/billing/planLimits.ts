...
> = {
  ...
  matchOverlays: {
    kind: 'code',
    where:
      'utils/billing/tenantCapabilityGate.ts → GET /api/overlay/match/[matchId] + GET /api/overlay/day + GET /api/overlay/scrims + GET /api/overlay/scrim-result + GET /api/overlay/donations (402 si le palier ne l’ouvre pas)',
  },
  maxLeagues: {
    kind: 'code',
