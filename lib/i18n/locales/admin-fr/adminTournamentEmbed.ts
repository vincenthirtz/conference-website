...
export default adminNs('adminTournamentEmbed', {
  ...
  daySendError: 'Envoi impossible.',
  dayForcedStatus: 'La source OBS affiche le {day} (jusqu’à {until})',
  dayResetBtn: 'Revenir au jour même',
  dayLiveStatus: 'La source OBS affiche le jour même.',
  dayTestHint:
    '« Tester » ouvre un aperçu ; « Envoyer dans OBS » fait afficher ce jour à la source déjà collée, pendant 12 h au plus. Son URL ne change pas.',
  copiedBtn: 'Copié',
