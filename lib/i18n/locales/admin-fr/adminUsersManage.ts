...
export default adminNs('adminUsersManage', {
  ...
  logsTitle: 'Journal du compte',
  logsModalTitle: 'Journal du compte',
  logsEmpty: 'Aucune action enregistrée sur ce compte.',
  logsBy: 'par {who} · {date}',
  logsScopeHint:
    "Actions du staff portant sur le compte lui-même (rôle, suspension, accès, profil). Les modifications de roster sont journalisées sur la fiche de l'équipe.",
  errLogs: 'Échec du chargement du journal.',
  close: 'Fermer',
  suspendedBadge: 'Suspendu',
  suspendedBadgeTitle: 'Connexion refusée jusqu’au {date}.',
  discordBadge: 'Discord',
  discordBadgeTitle: 'Compte Discord lié : {username}',
  ...
  suspendDuration30d: '30 jours',
  suspendDurationPermanent: 'Sans échéance',
  suspendConfirmBtn: 'Suspendre',
  toastSuspended: 'Compte suspendu.',
  toastUnsuspended: 'Suspension levée.',
  errSuspend: 'Échec de la mise à jour de la suspension.',
  confirmUnsuspendTitle: 'Lever la suspension ?',
  confirmUnsuspendSubtitle: '{name} pourra de nouveau se connecter.',
  confirmUnsuspendBtn: 'Lever',
  filterSuspended: 'Suspendu',
  filterNoDiscord: 'Sans Discord',
