...
export default adminNs('adminTeamEdit', {
  ...
  rosterLockIntro: "Ouvre une fenêtre pour CETTE équipe seulement. Elle se referme seule ; le tableau de bord du tournoi, lui, ouvre pour toutes les équipes.",
  rosterLockLocked: "Verrouillé : les capitaines et managers ne peuvent pas modifier la composition.",
