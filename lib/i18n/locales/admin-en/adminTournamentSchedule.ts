...
export default {
  ...
  applyChecking: 'Computing impact…',
  applyTitle: 'Move this match?',
  applySubtitle: '{label} → {time}',
  applyConfirm: 'Move',
  impactFixed: 'Fixes {count} anomaly/anomalies',
  impactBroken: 'Creates {count}',
  impactNone: 'Breaks nothing elsewhere.',
  impactBlocking: 'Careful: this move creates a BLOCKING anomaly.',
  moveDone: 'Match moved.',
  moveRefused: 'Move refused: it would create a blocking anomaly.',
  moveError: 'Could not move the match.',
