// lib/i18n/locales/admin-en/adminCustomGamePresets.ts
//
// Traductions ANGLAISES du namespace admin `adminCustomGamePresets`.
//
// La SOURCE DE VERITE est le francais (`../admin-fr/adminCustomGamePresets.ts`) : toute cle
