...
export default {
  ...
  lifecycleHeading: 'Space state',
  lifecycleActive: 'Active',
  lifecycleSuspended: 'Suspended',
  lifecycleArchived: 'Archived',
  lifecyclePurgeScheduled: 'Purge scheduled',
  lifecyclePurged: 'Purged',
  lifecycleReasonShown: 'Reason: {reason}',
  lifecyclePurgeAt: 'Erasure planned for {date}.',
  lifecycleEffects:
    'Suspended: site, API and bot answer 402 with the reason, data stays. Archived: nothing answers, data stays. Purge scheduled: reversible until the deadline.',
  lifecycleTargetLabel: 'New state',
  lifecycleReasonLabel: 'Reason',
  lifecycleReasonPlaceholder: 'Read by the client in the refusal they will get',
  lifecycleApply: 'Apply',
  lifecycleApplying: 'Applying…',
  lifecycleChanged: 'Space state updated.',
  lifecycleError: 'State change failed.',
};
