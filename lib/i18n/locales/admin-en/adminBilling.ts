...
export default {
  ...
  capBroadcastStudio: 'Video control room (auto-director + OBS overlays)',
  ...
  orderOffer: 'Offer',
  orderTerm: 'Billing period',
  orderTermMonth: 'Monthly',
  orderTermYear: 'Yearly',
  orderTotal: 'Total amount payable',
  orderDuration: 'Period opened',
  orderDurationMonth: 'One month from payment',
  orderDurationYear: 'Twelve months from payment',
  orderNoRenewal:
    'No tacit renewal and no automatic debit: the next period will be a new order.',
  orderModify: 'Change',
  orderCgvBefore: 'I have read and accept the ',
  orderCgvLink: 'terms and conditions of sale',
  orderCgvAfter: ' (version {version}).',
  orderWaiver:
    'I request immediate performance of the service and acknowledge that once it is fully performed I will lose my fourteen-day right of withdrawal.',
  orderConsentRequired: 'Both boxes must be ticked to place the order.',
  orderSubmit: 'Order with obligation to pay',
  perMonth: '/ mo',
