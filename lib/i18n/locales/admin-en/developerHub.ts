// lib/i18n/locales/admin-en/developerHub.ts
//
// Traductions ANGLAISES du namespace admin `developerHub`.
//
// La SOURCE DE VERITE est le francais (`../admin-fr/developerHub.ts`) : toute cle
