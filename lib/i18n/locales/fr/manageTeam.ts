...
export default ns('manageTeam', {
  ...
  teamNamePlaceholder: 'Nom complet',
  teamNameInvalid: 'Le nom doit faire entre 2 et 100 caractères.',
  teamShortNameLabel: 'Sigle',
  teamShortNamePlaceholder: 'Ex. EMB',
  teamShortNameInvalid: 'Le sigle ne peut pas dépasser 16 caractères.',
  teamCountryLabel: 'Pays',
  teamCountryPlaceholder: 'Ex. France',
  teamCountryInvalid: 'Le pays ne peut pas dépasser 56 caractères.',
  teamInfoUpdated: 'Informations de l’équipe mises à jour.',
  teamInfoError: 'La mise à jour n’a pas pu être enregistrée.',
