...
export default ns('tournamentStats', {
  ...
  hintTied: '{count} équipes à égalité',
  statTopWinrate: 'Top winrate',
  statBestMapDiff: 'Meilleure diff maps',
  top3Heading: 'Top 3 du classement',
  ...
  wdLabel: 'V/D :',
  mapsLabel: 'Maps :',
  heroBansHeading: 'Héros les plus bannis',
  mapBansHeading: 'Bans par map',
  mapBansIntro:
    'Pour chaque map jouée : combien de fois, combien de fois choisie par une équipe, et les héros qu’on y a bannis.',
  mapBansNone: 'Bans non relevés',
  mapBansChipTitle: '{hero} : banni {count} fois sur {maps} map(s) relevée(s)',
  colMap: 'Map',
  colMapPlayed: 'Jouée',
  colMapPicked: 'Choisie',
  colMapBans: 'Héros bannis',
  heroBansIntro: 'Sur {maps} maps dont les bans ont été relevés.',
  heroBansIntro_one: 'Sur 1 map dont les bans ont été relevés.',
  colHero: 'Héros',
  colRole: 'Rôle',
  colBans: 'Bans',
  colBanRate: 'Taux',
