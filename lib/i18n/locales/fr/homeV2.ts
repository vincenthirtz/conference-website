...
export default ns('homeV2', {
  ...
  playersEyebrow: 'Les joueuses',
  playersTitle: 'Elles font la compétition',
  playersLead:
    'Le haut du classement Glicko-2, mis à jour après chaque match officiel. Chaque joueuse a sa fiche : progression, bilan et face-à-face.',
  playersAll: 'Tout le classement',
  playersRecord: '{rating} pts · {wins}V – {losses}D',
  playersUnknown: 'Joueuse inconnue',
  playersMvpTitle: 'Dernières MVP de match',
