...
export default {
  ...
  teamNameInvalid: 'The name must be between 2 and 100 characters.',
  teamShortNameLabel: 'Tag',
  teamShortNamePlaceholder: 'e.g. EMB',
  teamShortNameInvalid: 'The tag cannot exceed 16 characters.',
  teamCountryLabel: 'Country',
  teamCountryPlaceholder: 'e.g. France',
  teamCountryInvalid: 'The country cannot exceed 56 characters.',
  teamInfoUpdated: 'Team information updated.',
  teamInfoError: 'The update could not be saved.',
